...
def getUserImageFromS3(user_id):
    # accessing object from bucket
    s3_key = f"users/{user_id}.png"
...
def lambda_handler(event, context):
    ...
    try:
        ...
        base64_image = getUserImageFromS3(user_id)
        
        # Return a success response
        response_body = {'message': f"User (with userId={user_id}) image retrieved successfully.", 'image': base64_image}
