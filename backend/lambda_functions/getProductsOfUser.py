...
def getProductDetailsById(product_id):
    # Assuming you have a 'products' collection
...
def lambda_handler(event, context):
    ...
    try:
        ...
        IdsOfProducts = getUserProductsFromId(userId)
        products = []
        for id in IdsOfProducts:
            products.append(getProductDetailsById(id))
